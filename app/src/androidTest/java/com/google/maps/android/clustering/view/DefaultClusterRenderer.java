...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private class RenderTask implements Runnable {
        ...
        @SuppressLint("NewApi")
        public void run() {
            if (clusters.equals(com.google.maps.android.clustering.view.DefaultClusterRenderer.this.mClusters)) {
                mCallback.run();
                return;
            }
            ...
            if (com.google.maps.android.clustering.view.DefaultClusterRenderer.this.mClusters != null && SHOULD_ANIMATE) {
                existingClustersOnScreen = new ArrayList<Point>();
                for (Cluster<T> c : com.google.maps.android.clustering.view.DefaultClusterRenderer.this.mClusters) {
            ...
            mMarkers = newMarkers;
            com.google.maps.android.clustering.view.DefaultClusterRenderer.this.mClusters = clusters;
            mZoom = zoom;
